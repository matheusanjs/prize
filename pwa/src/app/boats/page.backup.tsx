...
export default function BoatsPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Process highlighted trips (already fetched in parallel above)
    ...
    <>
      ...
      <div className="-mx-4 -mt-2 pb-4">
        ...
        {highlightedTrips.length > 0 ? (
          ...
          <div className="h-[300px] lx-shimmer" />
        ) : null}
        ...
        {showConfirmArrival && confirmReservation && (
          <div className="fixed inset-0 z-[10001] bg-black/70 backdrop-blur-md flex items-end" onClick={() => setShowConfirmArrival(false)}>
            <div className="w-full rounded-t-[28px] p-6 max-h-[85vh] overflow-auto lx-card" style={{ paddingBottom: 'calc(2.5rem + env(safe-area-inset-bottom, 0px))' }} onClick={e => e.stopPropagation()}>
